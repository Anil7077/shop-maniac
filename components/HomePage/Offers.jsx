        ...
        <>
            <div>
                ...
                <section id="banner3" className="section-p1">
                    <div className="banner-box" onClick={handleRoute}>
                        <h2>SEASONAL SALES</h2>
                        <h3>Winter Collection -50% OFF</h3>
                    </div>
                    <div className="banner-box banner-img2" onClick={handleRoute}>
                        <h2>SEASONAL SALES</h2>
                        <h3>Winter Collection -50% OFF</h3>
                    </div>
                    <div className="banner-box banner-img3" onClick={handleRoute}>
                        <h2>SEASONAL SALES</h2>
                        <h3>Winter Collection -50% OFF</h3>
                    </div>
                </section>
